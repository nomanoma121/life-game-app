    ...
    <>
      ...
      <div style={{ margin: "0 auto", width: "850px" }}>
        ...
        <div style={{marginTop: "30px"}}>
          <h3>ライフゲームとは...</h3>
          <p>ライフゲームとは4つのルールから生命の誕生や進化、淘汰をシミュレーションできるゲーム</p>
          <h4>主なルール</h4>
          <p>各セルには「生」と「死」の2つの状態があり、あるセルの次のステップ（世代）の状態は周囲の8つのセルの今の世代における状態により決定される。</p>
          <ol>
            ...
            <a href="https://ja.wikipedia.org/wiki/%E3%83%A9%E3%82%A4%E3%83%95%E3%82%B2%E3%83%BC%E3%83%A0">Wikipediaより引用</a>
          </ol>
          <PaternList/>
        </div>
      </div>
